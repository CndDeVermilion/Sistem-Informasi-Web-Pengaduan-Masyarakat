              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="cek_login_admin.php">
                    ...
                    <button type="submit" role="button" name="login" href="halaman_admin.php" class="btn btn-primary btn-user btn-block">
                      Login
                    </button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="index.php"><span><b>Ke Menu Beranda</b></span></a>
                  </div>
