              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
                    require 'conn.php';
                    $result = mysqli_query($db, "SELECT * FROM pengaduan WHERE status='proses'");
                    $no = 1;
                    ...
                    <tr>
                      ...
                      <td class="text center">
                        <a href="?url=detail_laporan&id=<?php echo $data['id_pengaduan']; ?>" class="btn btn-primary btn-icon-split">
